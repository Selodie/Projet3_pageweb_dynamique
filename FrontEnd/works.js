...
fetchProjects().then(projects =>  {
    ...
    for (const project of projects) {
        // on appel la fonction pour la création html des projets dans la page
...
inputImg.addEventListener('change', function(){
    ...
    if(fichier) {
        ...
        // écouteur d'évènement pour détecter le chargement complet du contenu du fichier et quand chargement erminé, définition de 
...
// fonctions utilisées dans les conditions
 ...
 // fonction pour faire apparaître les éléments dans la modal lors de l'ajout de projet
...
// fontiont pourle changement de couleur de bouton
